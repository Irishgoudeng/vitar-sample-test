...
const SpecificEquipmentPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchEquipments = async () => {
      ...
      // Create a query to filter for "Dimensional" equipment
      const equipmentQuery = query(
        equipmentCollectionRef,
        where("typeOfScope", "==", "Dimensional") // Adjust field name accordingly
      );
  ...
  const handleDelete = (equipmentID: string) => {
    ...
    if (confirmDelete) {
      ...
      router.push(`/dashboard/equipment/dimensional`);
    }
  };
